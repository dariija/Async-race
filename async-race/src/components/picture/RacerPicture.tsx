...
export default function RacerPicture({ colour, className }: Props) {
    return (
        <svg
            className={`racer__svg ${className}`}
            version="1.0"
        ...
        >
            ...
            <g transform="translate(0.000000,640.000000) scale(0.100000,-0.100000)" fill={colour} stroke="none">
                <path
